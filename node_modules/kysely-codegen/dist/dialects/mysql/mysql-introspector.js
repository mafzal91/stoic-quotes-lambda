...
var _MysqlIntrospector_instances, _MysqlIntrospector_createDatabaseMetadata, _MysqlIntrospector_getEnums;
...
class MysqlIntrospector extends introspector_1.Introspector {
    ...
    async introspect(options) {
        ...
        const enums = await __classPrivateFieldGet(this, _MysqlIntrospector_instances, "m", _MysqlIntrospector_getEnums).call(this, db);
        await db.destroy();
        const metadata = __classPrivateFieldGet(this, _MysqlIntrospector_instances, "m", _MysqlIntrospector_createDatabaseMetadata).call(this, tables, enums);
        return metadata;
    }
}
...
_MysqlIntrospector_instances = new WeakSet(), _MysqlIntrospector_createDatabaseMetadata = function _MysqlIntrospector_createDatabaseMetadata(tables, enums) {
    ...
    return new metadata_1.DatabaseMetadata(tablesMetadata, new enum_collection_1.EnumCollection());
}, _MysqlIntrospector_getEnums = async function _MysqlIntrospector_getEnums(db) {
