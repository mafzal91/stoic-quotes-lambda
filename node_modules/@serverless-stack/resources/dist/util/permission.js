...
import { Api, Job, RDS, Table, Topic, Queue, Bucket, EventBus, Function, AppSyncApi, WebSocketApi, KinesisStream, ApiGatewayV1Api, Stack, } from "../index.js";
...
function permissionsToStatementsAndGrants(permissions) {
    ...
    permissions.forEach((permission) => {
        ...
        ////////////////////////////////////
            ...
            statements.push(buildPolicyStatement("firehose:*", [permission.deliveryStreamArn]));
        }
