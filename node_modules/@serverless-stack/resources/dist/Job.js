...
export class Job extends Construct {
    ...
    buildCodeBuildProjectCode() {
        const { handler, srcPath: srcPathRaw, enableLiveDev: enableLiveDevRaw, } = this.props;
    ...
    useForCodeBuild(constructs) {
        ...
        constructs.forEach(c => {
            ...
            Object.entries(permissions).forEach(([action, resources]) => this.attachPermissionsForCodeBuild([new iam.PolicyStatement({
                    actions: [action],
                    effect: iam.Effect.ALLOW,
                    resources,
                })]));
